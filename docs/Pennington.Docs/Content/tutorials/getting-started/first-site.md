...
The tutorial covers how to wire `AddPennington`, `UsePennington`, and `RunOrBuildAsync` into a minimal web host — the same foundation underneath every Pennington-powered site, whether DocSite, BlogSite, or hand-rolled.
