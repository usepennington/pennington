...
| **Dark-mode / theme toggle** | Mentioned as chrome; no dedicated page. | Reference/explanation note: toggle behavior, inline head script + storage key, the `reinitializeForTheme` hook, the `dark:` variant convention. |
