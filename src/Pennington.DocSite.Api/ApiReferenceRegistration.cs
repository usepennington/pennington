...
/// <param name="SearchPriority">Search-index priority applied to every page under <paramref name="RoutePrefix"/>; lower ranks later.</param>
public sealed record ApiReferenceRegistration(string Name, string RoutePrefix, string? TocTitle, string? TocSectionLabel, int SearchPriority);