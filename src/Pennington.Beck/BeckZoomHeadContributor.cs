...
internal sealed class BeckZoomHeadContributor : IHeadContributor
{
    ...
    /// <summary>
    /// The assets with the dark-mode selector resolved from the configured
    /// <see cref="global::Beck.SvgRenderOptions.ThemeHooks"/> — the same signal the Beck SVGs on
    /// the page key their own dark tokens off, so the lightbox chrome always flips with them.
    /// </summary>
    internal string Assets => AssetsTemplate.Replace("{dark}", _options.RenderOptions.ThemeHooks.Dark);

    /// <summary>
    /// The zoom button/lightbox CSS and the dialog-opening script; <c>{dark}</c> marks where the
    /// host's dark-mode ancestor selector (default <c>[data-theme='dark']</c>) is substituted.
    /// Colors ride the host's <c>--color-base-*</c> ramp with slate fallbacks. The backdrop washes
    ...
    /// </summary>
    internal const string AssetsTemplate = """
        ...
        {dark} .beck-zoom{border-color:var(--color-base-700,#334155);background:color-mix(in srgb,var(--color-base-900,#0f172a) 88%,transparent);color:var(--color-base-400,#94a3b8)}
        {dark} .beck-zoom:hover{color:var(--color-base-50,#f8fafc);border-color:var(--color-base-600,#475569)}
        ...
        {dark} .beck-lightbox::backdrop{background-color:color-mix(in srgb,var(--color-base-950,#0d1117) 60%,transparent)}
        ...
        {dark} .beck-lightbox-panel{background:var(--color-base-950,#0d1117);border-color:var(--color-base-800,#1e293b)}
        ...
        {dark} .beck-lightbox-close{border-color:var(--color-base-700,#334155);background:color-mix(in srgb,var(--color-base-900,#0f172a) 88%,transparent);color:var(--color-base-400,#94a3b8)}
        {dark} .beck-lightbox-close:hover{color:var(--color-base-50,#f8fafc);border-color:var(--color-base-600,#475569)}
        </style>
