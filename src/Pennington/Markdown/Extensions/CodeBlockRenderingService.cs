...
/// <see cref="CodeBlockHtmlBuilder"/> (unless a preprocessor opts out with
/// <see cref="CodeBlockPreprocessResult.SkipChrome"/>). Used by both the Markdig renderer
        ...
        bool isInTabGroup = false)
    {
        ...
        foreach (var preprocessor in _preprocessors)
        {
            ...
            if (result != null)
            {
                ...
                return result.SkipChrome
                    ? html
                    : CodeBlockHtmlBuilder.BuildHtml(html, effectiveOptions, isInTabGroup, languageId);
            }
        }
