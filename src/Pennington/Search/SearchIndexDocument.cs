...
/// <param name="Description">Front-matter description; boosted relative to body.</param>
/// <param name="Headings">Space-joined H1–H6 text from the rendered page; boosted relative to body.</param>
