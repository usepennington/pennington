...
/// <summary>
/// Stage 1 — the starting point carried over from tutorial §1.1.20
/// (<c>GettingStartedFirstPageExample</c>): three markdown pages, a nav strip,
/// and no styling. Tutorial prose extracts the body of <see cref="Run"/> via
/// <c>xmldocid,bodyonly</c>. This class is never instantiated.
/// </summary>
public static class Stage1
{
    /// <summary>Run the pre-styling host so the tutorial has a concrete "before" picture.</summary>
