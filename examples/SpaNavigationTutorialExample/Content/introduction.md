...
In Penn, SPA navigation works through **islands** — named regions of the page that get swapped during navigation. The sidebar stays put while the content area updates.

## How It Works

1. User clicks a navigation link
2. Penn intercepts the click
