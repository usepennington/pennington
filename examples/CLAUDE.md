...
| `DocSiteChromeOverridesExample` | Override DocSite chrome via `DocSiteOptions` + head-slot fragment + custom routed `@page` + `AdditionalRoutingAssemblies`, plus a `Components/NotFound.razor` 404 body. | `how-to/response-pipeline/override-docsite-components.md`, `how-to/pages/not-found-page.md` |
